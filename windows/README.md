...
- `QuotaArc-1.6.4.msi` - double-click to install (Program Files, Start Menu, desktop shortcut). Installing again replaces the copy already on the machine. The last page has **Run Quota Arc**.
- `QuotaArc-1.6.4-portable-win-x64.zip` - unzip and run `QuotaArc.exe`
